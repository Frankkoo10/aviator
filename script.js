...
function transitionToCrashed(crashPoint) {
    ...
    if (enRondaActual && !yaCobro) {
        document.getElementById("multiplier-display").innerHTML = '<img src="imagen_golpe.png" alt="Crash" class="status-icon"> CRASHED';
        ...
        document.getElementById("multiplier-display").innerHTML = ' FLEW AWAY';
